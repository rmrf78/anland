...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ADDED: FloatBall (floating virtual buttons) initialization
        initFloatBall();
    ...
    private void toggleFloatBall() {
        if (floatBallManager == null) return;
        if (mFloatBallVisible) {
    ...
    protected void onPause() {
        ...
        mNative.stop();
        if (floatBallManager != null) floatBallManager.hide();
    }
    ...
    private void buildExtraKeysBar() {
        extraKeysBar = new ExtraKeysBar(this, new ExtraKeysBar.Sender() {
            ...
            @Override public void toggleFloatBall() {
                toggleFloatBall();
            }
